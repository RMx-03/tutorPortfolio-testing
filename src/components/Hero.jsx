      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-80px)]">
          ...
          <div className="relative hidden lg:block">
            <div className="relative w-full h-[600px] glass-card rounded-full overflow-hidden animate-float shadow-soft">
              ...
              {/* Floating Elements */}
              <div className="absolute top-[18%] left-[20%] glass-card p-4 rounded-full bg-white animate-float">
                <img src={plus} alt="Plus" className="w-12 h-12 object-cover" />
              </div>

              <div className="absolute top-[10%] right-[20%] glass-card p-4 rounded-full bg-white animate-float" style={{animationDelay: '1s'}}>
                <img src={multiply} alt="Multiply" className="w-12 h-12 object-cover" />
              </div>

              <div className="absolute bottom-[20%] left-[10%] glass-card p-4 rounded-full bg-white animate-float" style={{animationDelay: '1.5s'}}>
                <img src={minus} alt="Minus" className="w-12 h-12 object-cover" />
              </div>

              <div className="absolute bottom-[15%] right-[15%] glass-card p-4 rounded-full bg-white animate-float" style={{animationDelay: '2s'}}>
