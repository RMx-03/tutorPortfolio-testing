...
const About = () => {
  return (
    <section id="about" className="py-24 bg-gradient-to-br from-violet-950 to-neutral-900 relative">
      ...
      {/* bg-[url('https://images.pexels.com/photos/733856/pexels-photo-733856.jpeg')] */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="mt-12 grid grid-cols-3 gap-6">
          <div className="stats-card">
            <h3 className="text-3xl font-bold text-gray-100"><CountUp from={0} to={1000} separator="," direction="up" duration={1} className="count-up-text"/>+</h3>
            <p className="text-neutral-400">Students</p>
          </div>
          <div className="stats-card">
            <h3 className="text-3xl font-bold text-gray-100"><CountUp from={0} to={95} separator="," direction="up" duration={1} className="count-up-text"/>%</h3>
            <p className="text-neutral-400">Success Rate</p>
          </div>
          <div className="stats-card">
            <h3 className="text-3xl font-bold text-gray-100"><CountUp from={0} to={10} separator="," direction="up" duration={1} className="count-up-text"/>+</h3>
        ...
        <div className="mt-16">
          <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-8">
            <div className="bg-white glass-card p-8 hover:scale-105 transition-all duration-300">
              <dt className="flex items-center">
                ...
                <p className="ml-4 text-xl font-semibold text-black">Expert Faculty</p>
              </dt>
              <dd className="mt-4 text-neutral-700">
            ...
            <div className="bg-white glass-card p-8 hover:scale-105 transition-all duration-300">
              <dt className="flex items-center">
                ...
                <p className="ml-4 text-xl font-semibold text-black">Personalized Attention</p>
              </dt>
              <dd className="mt-4 text-neutral-700">
            ...
            <div className="bg-white glass-card p-8 hover:scale-105 transition-all duration-300">
              <dt className="flex items-center">
                ...
                <p className="ml-4 text-xl font-semibold text-black">Regular Assessments</p>
              </dt>
              <dd className="mt-4 text-neutral-700">
            ...
            <div className="bg-white glass-card p-8 hover:scale-105 transition-all duration-300">
              <dt className="flex items-center">
                ...
                <p className="ml-4 text-xl font-semibold text-black">Flexible Schedule</p>
              </dt>
              <dd className="mt-4 text-neutral-700">
